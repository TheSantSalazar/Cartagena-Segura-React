...
const createIcon = (color, isMine) => L.divIcon({
  className: '',
  html: `<div style="width:${isMine?32:26}px;height:${isMine?32:26}px;background:${color};border:${isMine?'3px':'2px'} solid white;border-radius:50% 50% 50% 0;transform:rotate(-45deg);box-shadow:0 2px 8px rgba(0,0,0,${isMine?'0.4':'0.2'})"></div>`,
...
// Componente para volar al centro
